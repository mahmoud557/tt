...
class manager_worker{
	constructor() {
		this.workers_url=['ch-w1.glitch.me','ch-w2.glitch.me','ch-w3.glitch.me','ch-w5.glitch.me','ch-w6.glitch.me','ch-w7.glitch.me','ch-w8.glitch.me','ch-w9.glitch.me'];
		//this.workers_url=['ca-w6.glitch.me'];
	...
	connect_to_worker(url,prev_res){
        ...
        const response = await fetch(`https://${url}/test`);
				const ws = new WebSocket(`wss://${url}/data`, {
				    headers: {
